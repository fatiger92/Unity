...
public class EffectManager : MonoBehaviour
{
    ...
    [SerializeField] private PrefabCacheData[] effectFiles;
    ...
    public GameObject GenerateEffect(int index, Vector3 position)
    {
        ...
        var go = SystemManager.Instance.GetCurrentSceneMain<InGameSceneMain>().EffectCacheSystem.Archive(filePath);
